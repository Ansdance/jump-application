...
describe('Statistic Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 16694 }];
      statistic.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 9125 }];
    ...
    it('Should call Player query and add missing value', () => {
      const statistic: IStatistic = { id: 456 };
      const employee: IPlayer = { id: 3900 };
      statistic.employee = employee;

      const playerCollection: IPlayer[] = [{ id: 21643 }];
    ...
    it('Should update editForm', () => {
      const statistic: IStatistic = { id: 456 };
      const task: ITask = { id: 31599 };
      statistic.tasks = [task];
      const employee: IPlayer = { id: 26570 };
      statistic.employee = employee;
