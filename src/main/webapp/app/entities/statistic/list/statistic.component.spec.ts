...
import { sampleWithRequiredData } from '../statistic.test-samples';
...
describe('Statistic Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.statistics?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to statisticService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStatisticIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStatisticIdentifier).toHaveBeenCalledWith(entity);
