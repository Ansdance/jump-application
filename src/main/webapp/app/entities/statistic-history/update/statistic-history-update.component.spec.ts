...
describe('StatisticHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call statistic query and add missing value', () => {
      ...
      const statistic: IStatistic = { id: 8694 };
      statisticHistory.statistic = statistic;

      const statisticCollection: IStatistic[] = [{ id: 20921 }];
    ...
    it('Should call department query and add missing value', () => {
      const statisticHistory: IStatisticHistory = { id: 456 };
      const department: ITournament = { id: 13432 };
      statisticHistory.department = department;

      const departmentCollection: ITournament[] = [{ id: 11015 }];
    ...
    it('Should call employee query and add missing value', () => {
      const statisticHistory: IStatisticHistory = { id: 456 };
      const employee: IPlayer = { id: 8861 };
      statisticHistory.employee = employee;

      const employeeCollection: IPlayer[] = [{ id: 20188 }];
    ...
    it('Should update editForm', () => {
      const statisticHistory: IStatisticHistory = { id: 456 };
      const statistic: IStatistic = { id: 19126 };
      statisticHistory.statistic = statistic;
      const department: ITournament = { id: 30348 };
      statisticHistory.department = department;
      const employee: IPlayer = { id: 5207 };
      statisticHistory.employee = employee;
