...
import kz.jumpkz.jumpapp.service.PlayerService;
...
/**
 * REST controller for managing {@link kz.jumpkz.jumpapp.domain.Player}.
 */
@RestController
...
public class PlayerResource {
    ...
    public ResponseEntity<List<PlayerDTO>> getAllPlayers(
        ...
        if ("statistichistory-is-null".equals(filter)) {
            log.debug("REST request to get all Players where statisticHistory is null");
            return new ResponseEntity<>(playerService.findAllWhereStatisticHistoryIsNull(), HttpStatus.OK);
        }
