...
/**
 * Service Interface for managing {@link kz.jumpkz.jumpapp.domain.Location}.
 */
public interface LocationService {
    ...
    /**
     * Get all the LocationDTO where Tournament is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<LocationDTO> findAllWhereTournamentIsNull();
